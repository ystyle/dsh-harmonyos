...
function patchAll() {
  ...
  return { credential: r1, session: r2, permission: r3, attachment: r4, attachmentAlias: r4b, vision: r5, cordisLoader: r6, settingsCompat: r7, loopbackAuth: r8, fsLocal: r9, fsSearch: r10, sandboxPolicy: r11, nodeAddonFlock: r12, clientResources: r13, requireBuiltin: r14 };
}
